...
# ----------------------------------------------------------
def generate_ring_points_ccw(radius_um, arc_spacing_um, dwell_time_ns):
    """
    ...
    num_points = max(6, int(circumference / arc_spacing_um))
    points = []
    dwell_times = []
...
# ----------------------------------------------------------
def generate_ring_points_cw(radius_um, arc_spacing_um, dwell_time_ns):
    """
...
# ----------------------------------------------------------
def generate_concentric_rings(num_rings, ring_spacing_um, arc_spacing_um, dwell_time_ns, direction):
    """
    ...
    for i in range(num_rings):
        ...
        if direction == "ccw":
            pts, dts = generate_ring_points_ccw(radius, arc_spacing_um, dwell_time_ns)
        elif direction == "cw":
            pts, dts = generate_ring_points_cw(radius, arc_spacing_um, dwell_time_ns)
...
def generate_zigzag_pattern(num_rings, ring_spacing_um, arc_spacing_um, dwell_time_ns, direction):
    ...
    ring_pts, _ = generate_concentric_rings(
        num_rings, ring_spacing_um, arc_spacing_um, dwell_time_ns, direction
    )
